  ...
  return (
    <div className="player screen ">
      <div className="overlap-group-C61RwL">
        ...
        <div className="borderline-4eduM0 valign-text-middle border-class-1">{borderline}</div>
        <div className="tame-impala-4eduM0 valign-text-middle border-class-1">{tameImpala}</div>
